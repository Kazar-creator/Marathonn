...
--
-- Host: localhost:3306
-- Creato il: Mag 04, 2026 alle 12:20
...
INSERT INTO `episodes` (`id`, `id_season`, `episode_number`, `title`, `description`, `duration`, `stream_url`, `thumbnail_url`) VALUES
(1, 1, 1, 'Pilot', 'Walter White scopre di avere un cancro e decide di produrre metanfetamina.', 58, 'https://demo.local/breakingbad-s1e1.mp4', NULL),
(2, 1, 2, 'Cat in the Bag...', 'Walter e Jesse cercano di smaltire i corpi.', 48, 'https://demo.local/breakingbad-s1e2.mp4', NULL),
(3, 1, 3, '...And the Bag in the River', 'Walter deve scegliere se uccidere un uomo.', 47, 'https://demo.local/breakingbad-s1e3.mp4', NULL),
(4, 1, 4, 'Cancer Man', 'Walt va dal suo oncologo per i risultati.', 47, 'https://demo.local/breakingbad-s1e4.mp4', NULL),
(5, 1, 5, 'Gray Matter', 'Walt va a una festa da un vecchio amico.', 47, 'https://demo.local/breakingbad-s1e5.mp4', NULL),
(6, 1, 6, 'Crazy Handful of Nothin', 'Walt sconvolge Tuco con una sostanza esplosiva.', 47, 'https://demo.local/breakingbad-s1e6.mp4', NULL),
(7, 1, 7, 'A No-Rough-Stuff-Type Deal', 'Walt e Jesse entrano in affari con Tuco.', 47, 'https://demo.local/breakingbad-s1e7.mp4', NULL);
...
INSERT INTO `seasons` (`id`, `id_media`, `season_number`, `title`, `poster_url`) VALUES
(1, 1, 1, 'Season 1', NULL);
...
ALTER TABLE `episodes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id_season` (`id_season`,`episode_number`);
...
ALTER TABLE `seasons`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id_media` (`id_media`,`season_number`);
...
--
ALTER TABLE `seasons`
  ADD CONSTRAINT `seasons_ibfk_1` FOREIGN KEY (`id_media`) REFERENCES `media` (`id`) ON DELETE CASCADE;
